...
async def configure_event_handlers(client, user_id):
    ...
    @client.on(events.NewMessage(pattern=r'^cvy hastle (.+) (\d+[smhd])$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy stop$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy ping$'))
    async def ping_handler(event):
        await event.reply("🏓 Pong! Bot aktif.")

    @client.on(events.NewMessage(pattern=r'^cvy bcstar (.+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy bcstargr(\d+) (\d+[smhd]) (.+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy stopbcstargr(\d+)$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy bl$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy unbl$'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy help$'))
    async def help_handler(event):
        help_text = (
            "📋 **Daftar Perintah yang Tersedia:**\n\n"
            "1. cvy hastle [pesan] [waktu][s/m/h/d]\n"
            ...
            "5. cvy bcstargr[1-10] [waktu][s/m/h/d] [pesan]\n"
            "   Broadcast hanya ke grup dengan interval tertentu.\n"
            "6. cvy stopbcstargr[1-10]\n"
    ...
    @client.on(events.NewMessage(pattern=r'^cvy setreply'))
    ...
    @client.on(events.NewMessage(pattern=r'^cvy stopall$'))
